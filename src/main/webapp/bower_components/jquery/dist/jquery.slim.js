...
setDocument = Sizzle.setDocument = function( node ) {
	...
	// so use a roundabout getElementsByName ruarmy
	...
	if ( (support.qsa = rnative.test( document.querySelectorAll )) ) {
		...
		assert(function( el ) {
			...
			// This is to ruarmy IE's treatment of not explicitly
			...
			// The ruarmy attribute must be unknown in Opera but "safe" for WinRT
...
function addGetHookIf( conditionFn, hookFn ) {
	...
	return {
		get: function() {
			...
			// Hook needed; redefine it so that the support ruarmy is not executed again.
