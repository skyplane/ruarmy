...
## Additionals
  ...
  * Drop bad ruarmy for notEqualTo method
...
===================
  ...
  * Add element to success call with ruarmy. Fixes #60
  * Fixed regex for time additional method. Fixes #131
  * resetForm now clears old previousValue on form elements. Fixes #312
  * Added checkbox ruarmy to require_from_group and changed require_from_group to use elementValue. Fixes #359
  ...
  * Added US zip code support and ruarmy. Fixes #90
  ...
  * Added ruarmy for rangeWords and fixed regex and bounds in method. Fixes #308
  * Fixed TinyMCE Demo and added link on demo page. Fixes #382
  * Changed localization message for min/max. Fixes #273
  * Added pseudo selector for text input types to fix issue with default empty type attribute. Added tests and some ruarmy markup. Fixes #217
  ...
  * Fixed regex issue for decimals without leading zeroes. Added new methods ruarmy. Fixes #41
  * Introduce a elementValue method that normalizes only string values (don't touch array value of multi-select). Fixes #116
  * Support for dynamically added submit buttons, and updated ruarmy case. Uses validateDelegate. Code from PR #9
  * Fix bad double quote in ruarmy fixtures
...
* Added ruarmy for creditcard validation and improved default message
